	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="col-sm-6 form-group{{ $errors->has('bottom_shade_color_1') ? ' has-error' : '' }}">
				...
				{!! Form::text('bottom_shade_color_1', old('bottom_shade_color_1'), ['class' => 'form-control', 'placeholder' => 'Bottom Bar Shade1 Color Code']) !!}
			...
			<div class="col-sm-6 form-group{{ $errors->has('bottom_shade_color_2') ? ' has-error' : '' }}">
				...
				{!! Form::text('bottom_shade_color_2', old('bottom_shade_color_2'), ['class' => 'form-control', 'placeholder' => 'Bottom Bar Shade2 Color Code']) !!}
			...
			<div class="col-sm-6 form-group{{ $errors->has('button_color_code') ? ' has-error' : '' }}">
				...
				{!! Form::text('button_color_code', old('button_color_code'), ['class' => 'form-control', 'placeholder' => 'Button Color Code']) !!}
