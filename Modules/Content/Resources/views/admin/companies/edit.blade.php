...
<h1>
	Edit Company: <small>{{ $company->name }}</small>
</h1>
<ol class="breadcrumb">
...
@section('content')
{!! Form::open(['route' => ['admin.content.company.update', $company->id], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
<div class="row">
	<div class="col-md-12">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
									...
									{!! Form::radio('status', 1, ($company->status)) !!}
									{!! $errors->first('status', '<span class="help-block">:message</span>') !!}
									&nbsp;&nbsp;
									{!! Form::label('status', trans('Disable')) !!}
									{!! Form::radio('status', 0, (!$company->status)) !!}
									{!! $errors->first('status', '<span class="help-block">:message</span>') !!}
								</div>
							...
							<div class="col-sm-6">
								<div class="col-sm-6" style="border-left: 1px solid #cccccc;">
									...
									<div class="col-sm-6">
										<?php $imageUrl = !empty ($company->logo) ? env('IMG_URL1') . $company->logo : ''; ?>
										<img class="select_img" src="{{ $imageUrl }}" onchange="previewFile()" width="120">
									</div>
								</div>
							</div>
						</div>
